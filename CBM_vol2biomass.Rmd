...
| spatialID     | Data table | Summary table of raster input data with 1 row for each `masterRaster` pixel that is not `NA` | CBM_dataPrep_SK                           |
...
| table 3       | Data table | Boudewyn table used in volume-to-biomass translations | <https://nfi.nfis.org/resources/biomass_models/appendix2_table3.csv>        |
| table 4       | Data table | Boudewyn table used in volume-to-biomass translations | <https://nfi.nfis.org/resources/biomass_models/appendix2_table4.csv>        |
| table 5       | Data table | Boudewyn table used in volume-to-biomass translations | <https://nfi.nfis.org/resources/biomass_models/appendix2_table5.csv>        |
| table 6       | Data table | Boudewyn table used in volume-to-biomass translations | <https://nfi.nfis.org/resources/biomass_models/appendix2_table6.csv>        |
| table 7       | Data table | Boudewyn table used in volume-to-biomass translations | <https://nfi.nfis.org/resources/biomass_models/appendix2_table7.csv>        |
| cbmAdmin      | Data table | Provides ecozone and spatial unit information for provincial boundaries | <https://drive.google.com/file/d/1xdQt9JB5KRIw72uaN5m3iOk8e34t9dyz>         |
...
|-------------------|------------|-------------|
| cumPoolsClean     | Data table | Tonnes of carbon/ha both cumnulative and increments, for each growth curve id, by age and ecozone |
| growth_increments | Data table | 1/2 increment matrix |
